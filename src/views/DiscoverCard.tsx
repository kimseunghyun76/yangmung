...
export function DiscoverCardView({ card, onNext }: { card: DiscoverCard; onNext: () => void }) {
  return (
    <div className="ym-reveal" style={{ textAlign: 'center' }}>
      <div className="ym-burst" style={{ marginTop: 8, color: 'var(--accent)' }}><Icon name="discover" size={44} /></div>
      ...
      <div style={{ textAlign: 'center', marginTop: 14 }}>
        <button style={{ ...BTN, padding: '10px 22px', fontSize: 18, background: COLORS.indigoSoft }} onClick={() => speak(card.ja)} disabled={!ttsSupported()}><Icon name="listen" size={17} /> 확인</button>
      </div>
