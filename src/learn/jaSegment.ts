...
const PREDICATES = [
  ...
  // 작문 최다빈출 문장(미션 답변) 지원 — 통째 활용형
  'たすけてください', 'かくにんしました', 'たすかりました', 'おぼえておきます',
  'いってみます', 'よやくしています', 'きをつけます', 'いただきます',
  'そうします', 'きます',
];
...
const CURATED_WORDS = [
  ...
  // 작문 최다빈출 문장(미션 답변) 지원
  'ひとつ', 'ふたつ', 'そう', 'たのしみ', 'ふたり', 'べつべつ', 'もちかえり', 'ちょうしょく', 'どちら', 'また', 'スイカ', 'へや',
  // 작문 4배 확장(2026-07-05) 지원 — 자주 재사용되는 지시어·명사
  'こちら', 'そちら', 'あちら', 'つかいかた', 'りょうしゅうしょ', 'パスポート',
];
