...
export const extraTravelUnits: Unit[] = [
  ...
  },
  {
    ...
    newPhraseIds: [
      ...
      'p_new_tsuurogawa_de', 'p_new_madogawa_de', 'p_new_card_kakunin', 'p_new_card_ni_henkin', 'p_new_genkin_de_henkin', 'p_new_kono_muki_de_ii', 'p_new_meisai_shobun', 'p_new_karaa_a4_de',
      'p_new_ryoumen_de', 'p_new_katamen_de', 'p_new_yoyaku_namae_desu', 'p_new_bangou_nana_desu', 'p_new_megahon_iro', 'p_new_seki_ni_modorimasu', 'p_new_chizu_misete',
