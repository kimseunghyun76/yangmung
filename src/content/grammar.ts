...
export const grammar: GrammarPoint[] = [
  ...
  // ── 문화·매너 ──
  { id: 'g_no_tip', category: '문화', label: '팁 문화 없음', tipKo: '일본은 팁이 없어요. 거스름돈을 두고 나오면 오히려 점원이 쫓아옵니다. 계산한 만큼만 내면 됩니다.', commonMistake: '거스름돈을 테이블에 남겨 두면 직원이 쫓아와 돌려줍니다.', action: '계산 후 거스름돈을 꼭 챙기고 ありがとうございました 한마디를 남기세요.', missionIds: ['C2'] },
  ...
  { id: 'g_quiet_train', category: '문화', label: '전철에선 통화 자제', tipKo: '전철·버스 안 통화는 민폐로 봐요. 진동으로 바꾸고 대화도 작게. 「マナーモード」(매너 모드).', commonMistake: '이어폰 없이 영상 소리를 틀면 민폐로 봐요 — 반드시 이어폰을 사용하세요.', action: '탑승 전 스마트폰을 진동(マナーモード)으로 전환하는 습관을 들이세요.', missionIds: ['C3'] },
  { id: 'g_queue', category: '문화', label: '줄서기·에스컬레이터', tipKo: '승강장 표시선에 줄 서고, 에스컬레이터에서는 걷지 않는 것이 현재 권장 원칙입니다.', commonMistake: '지역별 관행만 믿고 급하게 걷다가 충돌하기 쉬워요.', action: '바닥 표시와 현장 안내를 우선 확인하세요.', missionIds: ['C46'] },
  { id: 'g_cash', category: '문화', label: '현금도 챙기기', tipKo: '카드·IC가 늘었지만 작은 가게·식권기는 현금만인 곳도. 동전·천엔권을 조금 준비하면 편해요.', exampleJa: 'ATMはどこですか', exampleKo: 'ATM은 어디에 있나요?', action: '편의점 ATM에서 소액 인출하면 수수료가 낮을 수 있어요.', missionIds: ['C10', 'C43'] },
  { id: 'g_shoes', category: '문화', label: '신발 벗는 곳', tipKo: '다다미방·일부 식당·숙소는 신발을 벗어요. 입구에 단차나 신발장이 있으면 벗으라는 신호.', exampleJa: '靴を脱ぎますか', exampleKo: '신발을 벗어야 하나요?', action: '입구에 단차나 신발장이 보이면 신발을 벗고 뒤꿈치를 문 쪽으로 가지런히 놓으세요.', missionIds: ['C4'] },
  { id: 'g_itadakimasu', category: '문화', label: 'いただきます / ごちそうさま', tipKo: '먹기 전 いただきます, 다 먹고 ごちそうさま(でした). 식당 나설 때 한마디면 인상이 좋아져요.', exampleJa: 'ごちそうさまでした', exampleKo: '잘 먹었습니다.', action: '식사 전후 소리 내어 いただきます / ごちそうさまでした를 말해 보세요.', missionIds: ['C2', 'C13'] },
  { id: 'g_oshibori', category: '문화', label: 'おしぼり(물수건)', tipKo: '식당에서 주는 물수건은 손을 닦는 용도예요. 얼굴·테이블을 닦는 건 매너가 아니에요.', commonMistake: '얼굴이나 테이블을 닦으면 실례로 볼 수 있어요.', action: '오시보리는 손만 닦은 뒤 접어서 받침 위에 올려두세요.', missionIds: ['C2', 'C13'] },
  ...
  // ── 여행 실전 ──
  { id: 'g_konbini', category: '여행', label: '편의점 만능', tipKo: '편의점에서 ATM 출금·택배(택큐빈)·티켓·복사·공과금까지 돼요. 막히면 일단 편의점.', exampleJa: 'コピー機はありますか', exampleKo: '복사기가 있나요?', action: '편의점에서 ATM·택배·티켓 발권·복사·스캔·공과금 납부까지 할 수 있어요.', missionIds: ['C1', 'C12', 'C43', 'C44'] },
  { id: 'g_menzei', category: '여행', label: '면세는 여권 필수', tipKo: '면세(免税)는 여권이 있어야 해요. 보통 한 점포 5,000엔 이상. 개봉 금지 봉투로 포장해 줍니다.', exampleJa: '免税できますか', exampleKo: '면세 되나요?', action: '계산대에서 여권을 바로 꺼낼 수 있게 미리 손에 들고 계세요.', missionIds: ['C7', 'C40'] },
  { id: 'g_ic_card', category: '여행', label: 'IC카드(Suica) 한 장', tipKo: '전철·버스·편의점·자판기까지 탭 한 번. 충전은 「チャージ」. 모바일 Suica도 편해요.', exampleJa: 'チャージしてください', exampleKo: '충전해 주세요.', action: '역 자동발매기에서 「チャージ」 버튼을 찾아 원하는 금액으로 충전하세요.', missionIds: ['C3'] },
  { id: 'g_translate', category: '여행', label: '막히면 번역앱 카메라', tipKo: '메뉴·간판이 안 읽히면 번역앱 카메라로 비추면 돼요. 그래도 인사·숫자는 입으로 해보는 게 빨라요.', exampleJa: 'これは何ですか', exampleKo: '이게 뭔가요?', action: '번역앱 카메라로 메뉴를 비추고, 먹고 싶은 걸 가리키며 これをください라고 말해 보세요.', missionIds: ['C5', 'C50'] },
  ...
  { id: 'g_sushi', category: '장면', label: '스시 알레르기는 먼저', tipKo: '알레르기나 못 먹는 재료는 주문 전에 먼저 알리는 것이 안전합니다.', exampleJa: 'アレルギーがあります', exampleKo: '알레르기가 있습니다.', action: '재료 사진이나 번역 화면도 함께 보여주세요.', missionIds: ['C17', 'C38', 'C49'] },
  { id: 'g_tourist_info', category: '장면', label: '관광안내소를 활용하기', tipKo: '지도·행사·교통 정보를 한 번에 얻기 좋은 장소입니다.', exampleJa: 'ここはどこですか', exampleKo: '여기는 어디예요?', action: '가고 싶은 장소 화면을 보여주며 길을 물어보세요.', missionIds: ['C18'] },
  { id: 'g_shrine', category: '장면', label: '촬영 금지 표시 확인', tipKo: '신사·절 내부 일부 공간은 촬영이 금지될 수 있습니다.', exampleJa: '写真を撮ってもいいですか', exampleKo: '사진 찍어도 되나요?', action: '撮影禁止 표지가 보이면 카메라를 넣으세요.', missionIds: ['C19'] },
  { id: 'g_onsen', category: '장면', label: '온천은 씻고 들어가기', tipKo: '탕에 들어가기 전에 몸을 씻고, 수건은 탕 안에 넣지 않습니다.', action: '시설별 문신·수영복 규칙은 입구 안내를 확인하세요.', missionIds: ['C20'] },
  { id: 'g_ryokan', category: '장면', label: '료칸 식사 시간 확인', tipKo: '석식·조식 시간이 정해진 숙소가 많아 체크인 때 확인해야 합니다.', exampleJa: '朝食は何時ですか', exampleKo: '조식은 몇 시예요?', action: '도착이 늦으면 미리 숙소에 연락하세요.', missionIds: ['C21'] },
  { id: 'g_bus', category: '장면', label: '버스 승하차 방식 확인', tipKo: '지역에 따라 앞문·뒷문 승차와 선불·후불 방식이 다릅니다.', action: '앞사람의 행동과 교통카드 단말 위치를 먼저 보세요.', missionIds: ['C22'] },
  { id: 'g_shinkansen', category: '장면', label: '신칸센 표는 두 장일 수 있어요', tipKo: '승차권과 특급권이 따로 나오는 경우가 있습니다.', commonMistake: '개찰구에서 표 한 장을 빼먹기 쉬워요.', action: '개찰구에서 나온 표를 모두 다시 챙기세요.', missionIds: ['C23'] },
  { id: 'g_rental', category: '장면', label: '렌터카 반납 전 주유', tipKo: '대부분 가득 주유해 반납하고 영수증을 확인받습니다.', action: '내비게이션 언어와 보험 범위를 출발 전에 확인하세요.', missionIds: ['C24'] },
  { id: 'g_hospital', category: '장면', label: '병원에서는 증상을 짧게', tipKo: '아픈 위치·언제부터·알레르기 순서로 보여주면 전달이 빨라집니다.', exampleJa: 'お腹が痛いです', exampleKo: '배가 아파요.', action: '여권과 여행자 보험 정보를 준비하세요.', missionIds: ['C25'] },
  { id: 'g_police', category: '장면', label: '분실물은 交番으로', tipKo: '작은 파출소인 交番에서 길 안내와 분실 신고 도움을 받을 수 있습니다.', exampleJa: '助けてください', exampleKo: '도와주세요.', action: '분실 장소와 시간을 지도에 표시해 보여주세요.', missionIds: ['C26'] },
  { id: 'g_emergency', category: '장면', label: '긴급전화 110·119', tipKo: '경찰은 110, 구급·소방은 119입니다.', commonMistake: '긴급하지 않은 문의에 사용하면 대응을 방해합니다.', action: '위치와 상태를 먼저 말하고 통역을 요청하세요.', missionIds: ['C27'] },
  { id: 'g_sim', category: '장면', label: '유심은 호환성 확인', tipKo: '구매 전에 휴대폰 잠금 해제 여부와 지원 주파수를 확인해야 합니다.', action: '개통 확인 후 매장을 나가세요.', missionIds: ['C28'] },
  { id: 'g_laundry', category: '장면', label: '세제 자동 투입 확인', tipKo: '코인세탁기는 세제가 자동 투입되는 기계가 많습니다.', commonMistake: '세제를 중복으로 넣으면 거품이 과해질 수 있어요.', action: '洗剤自動投入 표시를 먼저 찾으세요.', missionIds: ['C29'] },
  { id: 'g_festival', category: '장면', label: '축제는 현금이 편해요', tipKo: '노점은 현금만 받는 곳이 많고 쓰레기통이 적을 수 있습니다.', action: '동전과 작은 봉투를 준비하면 편해요.', missionIds: ['C30'] },
  { id: 'g_kaiten_sushi_panel', category: '장면', label: '회전초밥은 패널부터', tipKo: '회전초밥집은 터치패널 주문, 접시 색상별 가격, 마지막 계산 버튼을 차례로 확인하면 덜 당황합니다.', exampleJa: '使い方を教えてください', exampleKo: '사용법을 알려 주세요.', action: '입장하면 먼저 언어 설정과 계산 버튼 위치를 봐 두세요.', missionIds: ['C31'] },
  { id: 'g_fitting_room', category: '장면', label: '피팅룸은 한마디 먼저', tipKo: '일본 옷가게는 피팅룸 전용 안내가 있을 수 있어요. 입어보기 전 試着してもいいですか 한마디가 안전합니다.', exampleJa: '試着してもいいですか', exampleKo: '입어 봐도 돼요?', action: '직원에게 사이즈와 색상을 함께 물어보세요.', missionIds: ['C32'] },
  { id: 'g_hotel_umbrella', category: '장면', label: '호텔 우산은 프런트에', tipKo: '비 오는 날 호텔 프런트에서 우산을 빌릴 수 있는 경우가 많습니다. 반납 위치와 시간만 확인하면 됩니다.', exampleJa: '傘を借りられますか', exampleKo: '우산을 빌릴 수 있나요?', action: '외출 전 프런트에서 傘ありますか라고 물어보세요.', missionIds: ['C33'] },
  { id: 'g_room_change', category: '장면', label: '객실 변경은 이유를 짧게', tipKo: '냄새·소음·침대 타입 문제는 길게 설명하지 말고 이유와 원하는 방을 짧게 말하면 처리하기 쉽습니다.', exampleJa: '部屋を変えられますか', exampleKo: '방을 바꿀 수 있나요?', action: '담배 냄새, 큰 방, 트윈 침대처럼 핵심 단어를 먼저 말하세요.', missionIds: ['C34'] },
  { id: 'g_narita_ticket', category: '장면', label: '공항역 표 교환은 창구로', tipKo: '오픈 티켓이나 교환권은 자동발매기보다 창구에서 날짜·시간·좌석을 함께 확인하는 편이 안전합니다.', exampleJa: 'このチケットを使いたいです', exampleKo: '이 티켓을 사용하고 싶어요.', action: '목적지와 원하는 출발 시간을 화면에 보여주세요.', missionIds: ['C35'] },
  { id: 'g_baggage_weight', category: '장면', label: '수하물 초과는 무게부터', tipKo: '공항에서 무게 초과가 나오면 추가요금, 짐 재정리, 기내 반입 가능 여부를 순서대로 확인하세요.', exampleJa: '荷物を出してもいいですか', exampleKo: '짐을 꺼내도 되나요?', action: '카운터 옆에서 정리해도 되는지 먼저 물어보세요.', missionIds: ['C36'] },
  { id: 'g_buffet_refill', category: '장면', label: '뷔페 리필 요청은 구체적으로', tipKo: '조식 뷔페에서 음식이 떨어졌을 때는 음식 이름이나 손짓으로 가리키며 ありますか라고 물으면 자연스럽습니다.', exampleJa: 'これ、もうありますか', exampleKo: '이거 더 있나요?', action: '빈 트레이를 가리키며 직원에게 짧게 물어보세요.', missionIds: ['C37'] },
  { id: 'g_pasta_options', category: '장면', label: '파스타 옵션은 하나씩 확인', tipKo: '소스·면 종류·세트·음료처럼 선택지가 많을 때는 한 번에 다 이해하려 하지 말고 하나씩 확인하세요.', exampleJa: 'おすすめはどれですか', exampleKo: '추천은 어느 건가요?', action: '못 들은 옵션은 もう一度お願いします로 다시 끊어 물어보세요.', missionIds: ['C39'] },
  { id: 'g_tax_free_checkout', category: '장면', label: '편집샵 계산은 면세 조건 확인', tipKo: '의류 매장 면세는 여권, 금액 조건, 개봉 금지 안내가 따라올 수 있습니다. 계산 전에 면세 가능 여부를 먼저 물어보세요.', exampleJa: '免税できますか', exampleKo: '면세 되나요?', action: '여권을 바로 꺼낼 수 있게 준비해 두세요.', missionIds: ['C40'] },
  ...
  { id: 'g_department_store', category: '문화', label: '백화점 계단·엘리베이터 예절', tipKo: '고급 백화점에서는 직원이 엘리베이터 안에서 층별 안내를 하는 경우가 있습니다. 들어갈 때와 나갈 때 가벼운 목례만 해도 충분해요.', action: '지하 식품관(デパ地下)은 시식이 가능한 경우가 많아요 — 구매 부담 없이 맛볼 수 있어요.', missionIds: ['C41', 'C47'] },
  ...
  // ── 추가 여행 팁 ──
  { id: 'g_shinkansen_seat', category: '여행', label: '신칸센 자유석·지정석 구분', tipKo: '신칸센 자유석(自由席)은 좌석 번호 없이 비어 있는 자리에 앉아요. 지정석(指定席)은 표에 적힌 칸·좌석에만 앉아야 합니다. 자유석 칸 번호는 탑승 전 확인하세요.', exampleJa: 'じゆうせきはどこですか', exampleKo: '자유석은 어디예요?', action: '플랫폼 안내판에서 自由席 구간 번호를 찾아 그 위치에 줄을 서세요.', missionIds: ['C23'] },
  { id: 'g_taximeter', category: '여행', label: '택시 미터와 가산 요금', tipKo: '일본 택시는 야간(심야)과 고속도로 이용 시 가산 요금이 붙습니다. 목적지를 지도나 메모로 보여주면 의사소통이 훨씬 쉬워요.', exampleJa: 'このじゅうしょまでおねがいします', exampleKo: '이 주소로 부탁합니다.', action: '지도 앱 목적지 화면을 택시 기사에게 보여주는 것이 가장 확실한 방법이에요.', missionIds: ['C8'] },
  { id: 'g_passport_carry', category: '여행', label: '여권은 상시 휴대', tipKo: '일본에서 외국인은 여권이나 그에 준하는 신분증을 상시 소지해야 하는 법적 의무가 있습니다. 면세 쇼핑·호텔 체크인·ATM 이용에도 여권이 필요한 경우가 많아요.', commonMistake: '여권을 숙소에 두고 나오면 면세 혜택을 받지 못하거나 신분 확인에 문제가 생길 수 있어요.', action: '여권은 여행 내내 몸에 지니고, 복사본을 숙소에도 한 부 남겨두세요.', missionIds: ['C9'] },
  ...
  { id: 'g_vending_machine', category: '여행', label: '자판기는 편의점만큼 다양', tipKo: '일본 자판기는 음료부터 우산·과자·라멘·어묵까지 팔아요. 동전과 천엔권을 넣으면 대부분 작동하고, IC카드 결제가 되는 기기도 많습니다.', exampleJa: 'これはいくらですか', exampleKo: '이건 얼마예요?', action: '가격 표시를 보고 IC카드 마크가 있으면 탭 결제를 시도해 보세요.', missionIds: ['C42'] },
  ...
  { id: 'g_body_language', category: '회화법', label: '몸짓이 반, 말이 반', tipKo: '여행 일본어는 100% 말로 해결할 필요가 없어요. 가리키기·손짓·지도 보여주기·번역앱을 조합하면 말이 짧아도 충분히 소통됩니다. 몸짓 언어를 적극 활용하세요.', action: '지도 앱, 번역앱, 메모 앱 세 가지를 여행 전에 준비해 두면 말문이 막혀도 안심이에요.', missionIds: ['C5', 'C50'] },
  ...
  // ── 추가 장면 팁 ──
  { id: 'g_food_court', category: '장면', label: '푸드코트 식권기 순서', tipKo: '푸드코트·라멘 가게는 입구 식권기(食券機)에서 먼저 표를 사고 자리에 앉는 방식이 많아요. 현금이 필요한 곳이 많으니 동전을 준비하세요.', exampleJa: 'つかいかたをおしえてください', exampleKo: '사용법을 알려 주세요.', action: '식권기에서 원하는 메뉴 버튼을 누르고 돈을 넣은 뒤 표를 받아 직원에게 주세요.', missionIds: ['C47'] },
  { id: 'g_izakaya_order', category: '장면', label: '이자카야 첫 음료는 빠르게', tipKo: '이자카야에서는 자리에 앉자마자 음료 주문을 먼저 받으러 옵니다. とりあえずビール(일단 맥주)가 대표 첫 주문이며, 못 마시면 ノンアルコールでお願いします라고 하면 무알콜을 주문할 수 있어요.', exampleJa: 'ノンアルコールでおねがいします', exampleKo: '무알콜로 부탁합니다.', action: '음료를 못 마신다면 ノンアルコール이라는 단어를 미리 외워두세요.', missionIds: ['C16'] },
  { id: 'g_cherry_blossom', category: '장면', label: '벚꽃 명소는 자리 경쟁', tipKo: '봄 벚꽃 시즌(오다이)(3~4월)에는 인기 공원에 이른 아침부터 돗자리로 자리를 맡아 두는 문화(場所取り)가 있습니다. 늦게 도착하면 좋은 자리를 구하기 어렵고 쓰레기는 직접 가져가세요.', action: '벚꽃 명소 방문 시 봉투와 비닐 시트를 준비하고 쓰레기는 직접 수거하세요.', missionIds: ['C30'] },
  { id: 'g_pharmacy_otc', category: '장면', label: '약국 일반의약품 구매', tipKo: '편의점에도 기본 상비약이 있지만 종류는 적어요. 드럭스토어(薬局·ドラッグストア)에서 감기약·진통제·위장약·반창고 등을 구매할 수 있습니다.', exampleJa: 'かぜぐすりはありますか', exampleKo: '감기약 있나요?', action: '약 봉투의 用法用量(용법용량)을 번역앱으로 찍어 확인하세요.', missionIds: ['C6', 'C48'] },
