...
export const phrases: Phrase[] = [
  ...
  { id: 'p_hai_onegai', kana: 'はい、おねがいします', kanji: 'はい、お願いします', korean: '네, 부탁합니다', register: 'productive', tip: '「はい、お願(ねが)いします」— 봉투·데우기·포인트카드 등 모든 YES 답변에 쓸 수 있어요. はい 하나보다 훨씬 자연스럽고 정중합니다' },
  { id: 'p_iie_kekkou', kana: 'いいえ、けっこうです', kanji: 'いいえ、結構です', korean: '아니요, 괜찮습니다 (정중하게 거절)', register: 'productive', tip: '「いいえ、結構(けっこう)です」— 가장 정중한 거절 표현. 봉투·영수증·포인트카드 권유를 거절할 때 써요. 「いりません」보다 부드러운 뉘앙스예요' },
  { id: 'p_hai_arimasu', kana: 'はい、あります', korean: '네, 있어요', register: 'productive', tip: '「はい、あります」— 포인트카드나 예약 여부 확인 질문에 YES로 답할 때. 간결하고 자연스러운 표현이에요' },
  { id: 'p_iie_arimasen', kana: 'いいえ、ありません', korean: '아니요, 없어요', register: 'productive', tip: '「いいえ、ありません」— 포인트카드가 없거나 예약이 없을 때. 없으면 당황하지 말고 이 한 마디면 충분해요' },
  { id: 'p_iie_irimasen', kana: 'いいえ、いりません', kanji: 'いいえ、要りません', korean: '아니요, 필요 없어요', register: 'productive', tip: '「いいえ、要(い)りません」— 봉투나 영수증이 필요 없을 때. エコバッグ(장바구니) 사용도 늘어 봉투 거절이 자연스러운 분위기예요' },
  { id: 'p_hai_wakarimashita', kana: 'はい、わかりました', kanji: 'はい、分かりました', korean: '네, 알겠습니다', register: 'productive', tip: '「はい、分(わ)かりました」— はい를 더해 더 성실하고 확실한 이해를 표현해요. 직원 안내를 이해했다는 확실한 신호입니다' },
  { id: 'p_hai_sou_desu', kana: 'はい、そうです', korean: '네, 그렇습니다', register: 'productive', tip: '「はい、そうです」— 이름·주문·내용 확인 질문에 YES. はい 단독보다 더 확실하게 동의하는 뉘앙스예요' },
  { id: 'p_hai_atatamete', kana: 'はい、あたためてください', kanji: 'はい、温めてください', korean: '네, 데워 주세요', register: 'productive', tip: '「はい、温(あたた)めてください」— 도시락·롤·찐빵 등을 살 때. あたためて만 해도 통하지만 はい를 붙이면 더 자연스러워요' },
  { id: 'p_iie_nanimoarimasen', kana: 'いいえ、なにもありません', kanji: 'いいえ、何もありません', korean: '아니요, 아무것도 없어요', register: 'productive', tip: '「いいえ、何(なに)もありません」— 분실물·알레르기·특별 요청 유무를 물을 때 "아무것도 없어요"라고 답하는 표현이에요' },
