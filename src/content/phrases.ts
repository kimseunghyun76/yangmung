...
export const phrases: Phrase[] = [
  ...
  { id: 'p_new_card_kakunin', kana: 'つかったかーどとおなじですか', kanji: '使ったカードと同じですか', korean: '사용했던 카드랑 같은 건가요?', register: 'productive', tip: '「使(つか)ったカードと同(おな)じですか」— 환불을 카드로 돌려준다고 안내받았을 때, 결제에 썼던 그 카드가 맞는지 확인하는 질문이에요' },
