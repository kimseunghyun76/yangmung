...
export const phrases: Phrase[] = [
  { id: 'p_hai', missionScope: 'generic',  kana: 'はい',   korean: '네',    register: 'both' },
  { id: 'p_iie',  kana: 'いいえ', korean: '아니요', register: 'both' },

  // ── 완성 문장형 응답 — 단답형 はい/いいえ를 대체하는 정중 회화체 ──
  { id: 'p_hai_onegai', missionScope: 'generic', kana: 'はいおねがいします', kanji: 'はい、お願いします', displayKana: 'はい、おねがいします', korean: '네, 부탁합니다', register: 'productive', tip: '「はい、お願(ねが)いします」— 봉투·데우기·포인트카드 등 모든 YES 답변에 쓸 수 있어요. はい 하나보다 훨씬 자연스럽고 정중합니다' },
  ...
  { id: 'p_hai_wakarimashita', missionScope: 'generic', kana: 'はいわかりました', kanji: 'はい、分かりました', displayKana: 'はい、わかりました', korean: '네, 알겠습니다', register: 'productive', tip: '「はい、分(わ)かりました」— はい를 더해 더 성실하고 확실한 이해를 표현해요. 직원 안내를 이해했다는 확실한 신호입니다' },
  ...
  { id: 'p_mou_ichido', missionScope: 'generic', kana: 'もういちどおねがいします', kanji: 'もう一度お願いします', displayKana: 'もういちど、おねがいします', korean: '다시 한 번 부탁합니다', register: 'productive', recoveryType: 'repeat', tip: '「もう一度(いちど)お願(ねが)いします」— 못 들었을 때 다시 말해달라는 표현. 부끄럽지 않아요 — 일본인도 친절하게 다시 말해줍니다. 뭔가 놓쳤을 때 당당하게 써요' },
  { id: 'p_yukkuri', missionScope: 'generic', kana: 'ゆっくりおねがいします', kanji: 'ゆっくりお願いします', displayKana: 'ゆっくり、おねがいします', korean: '천천히 부탁합니다', register: 'productive', recoveryType: 'slow', tip: '「ゆっくりお願(ねが)いします」— 말이 너무 빠를 때. 이 한 마디면 대부분의 일본인이 속도를 줄여줘요. もう一度와 함께 쓰면 더욱 효과적이에요' },
  ...
  { id: 'p_kore_kudasai', missionScope: 'generic', kana: 'これをください', displayKana: 'これを、ください', korean: '이거 주세요', register: 'productive', tip: '「これをください」— 메뉴나 상품을 가리키며 하는 가장 간단한 주문 표현. 일본어를 잘 몰라도 가리키며 이 한 마디로 주문 OK예요' },
  ...
  { id: 'p_genkin_de', missionScope: 'generic', kana: 'げんきんで', kanji: '現金で', korean: '현금으로요', register: 'productive', tip: '「現金(げんきん)で」— 현금 결제 선택. で는 수단을 나타내는 조사예요. 일본은 현금 문화가 강해 소규모 가게에선 현금만 받는 곳도 있어요' },
  { id: 'p_card_de', missionScope: 'generic', kana: 'カードで', korean: '카드로요', register: 'productive', tip: '「カードで」— 카드 결제 선택. 편의점·체인 식당은 대부분 카드 OK. 但(ただ)し 일부 소형 가게는 현금만 받으니 미리 확인하세요' },
  { id: 'p_kore_de', missionScope: 'generic', kana: 'これでおねがいします', kanji: 'これでお願いします', korean: '이걸로 부탁드려요', register: 'productive', tip: '「これでお願(ねが)いします」— 지갑·카드·IC카드를 보여주며 "이걸로 낼게요"라고 할 때. 어떤 결제 수단이든 보여주며 쓸 수 있는 만능 표현이에요' },
  ...
  { id: 'p_ikura_desu_ka', missionScope: 'generic', kana: 'いくらですか', displayKana: 'いくらですか？', korean: '얼마예요?', register: 'productive', grammarRefs: ['g_masuka'], tip: '「いくらですか」— 가격 확인 기본 표현. すみません、これはいくらですか로 더 완전하게 쓸 수 있어요. 가격표가 없는 반찬가게·시장에서 특히 유용해요' },
  { id: 'p_doko_desu_ka', missionScope: 'generic', kana: 'どこですか', displayKana: 'どこですか？', korean: '어디예요?', register: 'productive', grammarRefs: ['g_masuka'], tip: '「どこですか」— 위치 확인 기본 패턴. すみません、○○はどこですか 형태로 어디서든 응용 가능해요. 스마트폰 지도를 함께 보여주면 더 빠르게 안내받아요' },
  { id: 'p_daijoubu_desu', missionScope: 'generic', kana: 'だいじょうぶです', kanji: '大丈夫です', korean: '괜찮습니다 (정중)', register: 'both', tip: '「大丈夫(だいじょうぶ)です」— 상황에 따라 "괜찮습니다/됐습니다/필요 없어요" 등 여러 뉘앙스로 쓰여요. 봉투나 데우기를 거절할 때도 자연스럽게 씁니다' },
  ...
  { id: 'p_kousoku_de_onegai', kana: 'こうそくでおねがいします', kanji: '高速でお願いします', displayKana: 'こうそくで、おねがいします', korean: '고속도로로 부탁드려요', register: 'productive', tip: '「高速(こうそく)でお願(ねが)いします」— 시간을 아끼고 싶을 때 고속도로 이용을 요청. 一般道(いっぱんどう)의 반대 표현이에요' },
  { id: 'p_sono_kado_de_tomete', kana: 'そのかどでとめてください', kanji: 'その角で止めてください', displayKana: 'そのかどで、とめてください', korean: '그 모퉁이에서 세워 주세요', register: 'productive', tip: '「その角(かど)で止(と)めてください」— ここで止めてください보다 위치를 구체적으로 짚어 알려줄 때 써요' },
  ...
  // ── 콘텐츠 개편 2/N — 후반 장면의 단답 「감사합니다」 정답을 장면 맞춤 응답으로 ──
  { id: 'p_itte_mimasu', kana: 'いってみます', kanji: '行ってみます', korean: '가 볼게요', register: 'productive', tip: '「行(い)ってみます」— 길·위치 안내를 받은 뒤 "한번 가 볼게요". 감사만 하기보다 행동으로 이어가는 자연스러운 응답이에요' },
  { id: 'p_sagashite_mimasu', kana: 'さがしてみます', kanji: '探してみます', korean: '찾아볼게요', register: 'productive', tip: '「探(さが)してみます」— 위치를 안내받고 직접 찾아보겠다는 표현. 〜てみます는 "한번 ~해 보다"예요' },
  { id: 'p_kakunin_shimashita', kana: 'かくにんしました', kanji: '確認しました', displayKana: 'かくにん、しました', korean: '확인했어요', register: 'productive', tip: '「確認(かくにん)しました」— 잔돈·짐 등을 그 자리에서 확인했다는 표현. 거래·정리 장면에선 감사보다 확인이 먼저예요' },
  { id: 'p_sou_shimasu', kana: 'そうします', korean: '그렇게 할게요', register: 'productive', tip: '「そうします」— 안내·방법 설명을 듣고 "그대로 따를게요". 짧지만 행동 의사를 분명히 전해요' },
  { id: 'p_ki_o_tsukemasu', kana: 'きをつけます', kanji: '気をつけます', korean: '조심할게요', register: 'productive', tip: '「気(き)をつけます」— 주의·변상·출발 시간 안내를 듣고 "조심하겠습니다". 주의사항엔 감사보다 이 응답이 자연스러워요' },
  { id: 'p_tanoshimi_desu', kana: 'たのしみです', kanji: '楽しみです', korean: '기대돼요', register: 'productive', tip: '「楽(たの)しみです」— 추천·행사 안내를 듣고 "기대돼요". 대화가 더 따뜻하게 이어지는 반응이에요' },
  { id: 'p_sorede_onegai', kana: 'それでおねがいします', kanji: 'それでお願いします', displayKana: 'それで、おねがいします', korean: '그걸로 부탁드려요', register: 'productive', tip: '「それでお願(ねが)いします」— 제안받은 것을 "그걸로 해 주세요"로 수락하는 표현이에요' },
  { id: 'p_oboete_okimasu', kana: 'おぼえておきます', kanji: '覚えておきます', korean: '기억해 둘게요', register: 'productive', tip: '「覚(おぼ)えておきます」— 시간·규칙·위치 안내를 잊지 않게 "기억해 두겠습니다". 〜ておきます는 미리 준비해 두는 표현이에요' },
  { id: 'p_mou_juubun', kana: 'もうじゅうぶんです', kanji: 'もう十分です', korean: '이제 충분해요', register: 'productive', tip: '「もう十分(じゅうぶん)です」— "더 필요한 것 있나요?"에 "이제 충분합니다"로 마무리. 네/괜찮아요 같은 단답보다 분명해요' },
  { id: 'p_aruite_mimasu', kana: 'あるいてみます', kanji: '歩いてみます', korean: '걸어가 볼게요', register: 'productive', tip: '「歩(ある)いてみます」— 도보 거리를 안내받고 "걸어가 볼게요"로 응답해요' },
  { id: 'p_matte_imasu', kana: 'まっています', kanji: '待っています', korean: '기다릴게요', register: 'productive', tip: '「待(ま)っています」— "곧 해 드리겠다"는 안내에 "기다리고 있을게요"로 답해요' },
  ...
  { id: 'p_new_kinen_de_onegai', kana: 'きんえんでおねがいします', kanji: '禁煙でお願いします', korean: '금연으로 부탁드립니다', register: 'productive', tip: '「禁煙(きんえん)でお願(ねが)いします」— 프런트가 금연룸 여부를 확인할 때, 흡연/금연 중 원하는 쪽을 콕 집어 답하는 표현이에요. 「よろしいでしょうか」로 물으면 이렇게 조건을 확정해주면 됩니다' },
  { id: 'p_new_shokken_douzo', kana: 'はいこれです', kanji: 'はい、これです', displayKana: 'はい、これです', korean: '네, 여기 있어요', register: 'productive', tip: '「はい、これです」— 식권(食券)을 점원에게 건네주며 하는 말. 라멘집에서는 자판기로 식권을 산 뒤 자리에서 이렇게 내밀며 건네요' },
  { id: 'p_new_sen_nihyaku_en_desune', kana: 'せんにひゃくえんですね', kanji: '千二百円ですね', korean: '1200엔이요', register: 'productive', tip: '「千二百円(せんにひゃくえん)ですね」— 점원이 말한 금액을 따라 말하며 확인하는 표현. 계산할 때 금액을 복창하면 실수 없이 지불할 수 있어요' },
  { id: 'p_new_nimotsu_futatsu', kana: 'にもつがふたつあります', kanji: '荷物が二つあります', korean: '짐이 두 개 있어요', register: 'productive', tip: '「荷物(にもつ)が二(ふた)つあります」— 택시 기사가 짐 유무를 물을 때, 트렁크에 실을 짐의 개수를 구체적으로 알려주는 대답이에요. 개수는 상황에 맞게 바꿔 말하면 돼요' },
  { id: 'p_new_nimotsu_arimasen', kana: 'にもつはありません', kanji: '荷物はありません', korean: '짐 없어요', register: 'productive', tip: '「荷物(にもつ)はありません」— 짐이 없을 때 간단히 답하는 표현. 荷物が二つあります의 반대예요' },
  { id: 'p_new_sono_reeto_de_onegai', kana: 'そのレートでおねがいします', kanji: 'そのレートでお願いします', korean: '그 환율로 부탁드려요', register: 'productive', tip: '「そのレートでお願いします」— 직원이 안내한 환율에 동의하며 진행을 요청할 때 씁니다. 「レート」는 환율(rate)을 뜻하는 외래어예요' },
  { id: 'p_new_kozeni_shika_nai', kana: 'こぜにしかないんですけどだいじょうぶですか', kanji: '小銭しかないんですけど、大丈夫ですか', displayKana: 'こぜにしかないんですけど、だいじょうぶですか', korean: '동전밖에 없는데, 괜찮아요?', register: 'productive', tip: '「小銭(こぜに)しかないんですけど、大丈夫(だいじょうぶ)ですか」— 코인로커 요금을 안내받은 뒤 동전으로만 결제해도 되는지 확인할 때 씁니다. 코인로커는 지폐가 안 들어가는 기종이 많아서 실제로 자주 나오는 질문이에요' },
  { id: 'p_new_motto_hayaku_todoku', kana: 'もっとはやくとどきますか', kanji: 'もっと早く届きますか', korean: '더 빨리 도착할 수 있나요?', register: 'productive', tip: '「もっと早(はや)く届(とど)きますか」— 다음 날 배송을 제안받았을 때, 더 빠른 옵션(당일 등)이 있는지 구체적으로 되묻는 표현이에요. 택배 접수 창구에서 자주 쓰는 질문입니다' },
  { id: 'p_new_nimotsu_onegai', kana: 'にもつをおねがいします', kanji: '荷物をお願いします', korean: '짐 좀 부탁드려요', register: 'productive', tip: '「荷物(にもつ)をお願(ねが)いします」— 관광안내소 직원이 짐 보관이 가능하다고 안내했을 때, 실제로 맡기겠다고 요청하는 말이에요' },
  { id: 'p_new_bentou_hitotsu', kana: 'おべんとうをひとつください', kanji: 'お弁当を一つください', korean: '도시락 하나 주세요', register: 'productive', tip: '「お弁当(べんとう)を一(ひと)つください」— 신칸센 차내 판매원이 도시락과 음료를 권할 때, 필요한 것을 골라 주문하는 자연스러운 대답이에요' },
  { id: 'p_new_sara_kazoete', kana: 'さらをかぞえてください', kanji: '皿を数えてください', korean: '접시를 세어 주세요', register: 'productive', tip: '「皿(さら)を数(かぞ)えてください」— 회전초밥집은 쌓인 접시 색과 개수로 계산해요. 다 먹었으면 이렇게 접시를 세어 달라고 직접 요청할 수 있어요' },
  { id: 'p_new_tsume_dorekurai_kakaru', kana: 'そのおなおしどれくらいかかりますか', kanji: 'そのお直し、どれくらいかかりますか', displayKana: 'そのおなおし、どれくらいかかりますか', korean: '그 수선, 얼마나 걸려요?', register: 'productive', tip: '「お直(なお)し、どれくらいかかりますか」— 기장 줄임 등 수선을 제안받았을 때 소요 시간을 물어보는 표현이에요. 편집샵은 당일 수령이 안 되는 경우도 많아서 꼭 확인하게 되는 질문입니다' },
  { id: 'p_new_omelette_cheese_ire', kana: 'チーズをいれてください', kanji: 'チーズを入れてください', korean: '치즈 넣어 주세요', register: 'productive', tip: '「チーズを入(い)れてください」— 라이브 키친에서 셰프가 오믈렛을 즉석으로 만들어준다고 할 때, 원하는 속재료를 구체적으로 요청하는 표현이에요. 눈앞에서 만들어주는 요리라 재료 지정이 자연스러워요' },
  { id: 'p_new_supu_mo_onegai', kana: 'じゃあおおもりでおねがいしますスープもおねがいします', kanji: 'じゃあ大盛りでお願いします。スープもお願いします', displayKana: 'じゃあ、おおもりでおねがいします。スープもおねがいします', korean: '그럼 곱빼기로 주세요. 수프도 부탁해요', register: 'productive', tip: '「大盛(おおもり)りでお願(ねが)いします。スープもお願いします」— 무료 곱빼기와 수프 추가 제안을 둘 다 받아들일 때 쓰는 말이에요. 「곱빼기 되나요?」와 달리 이미 안내받은 뒤 확정 답변이에요' },
  { id: 'p_new_fullcover_onegai', kana: 'フルカバーでおねがいします', kanji: 'フルカバーでお願いします', korean: '풀커버로 부탁드려요', register: 'productive', tip: '「フルカバーでお願(ねが)いします」— 렌터카 보험을 풀커버로 가입하겠다고 답하는 표현. 하루 추가 요금이 들어도 안심하고 싶을 때 씁니다' },
  { id: 'p_new_jibun_de_hakobimasu', kana: 'じぶんではこびますのでだいじょうぶです', kanji: '自分で運びますので、大丈夫です', displayKana: 'じぶんではこびますので、だいじょうぶです', korean: '제가 직접 옮길게요, 괜찮아요', register: 'productive', tip: '「自分(じぶん)で運(はこ)びますので、大丈夫(だいじょうぶ)です」— 짐을 직접 옮기겠다며 직원의 도움을 정중히 사양할 때 쓰는 표현이에요' },
  { id: 'p_new_nagame_yori_kinen', kana: 'ながめよりきんえんのほうがだいじです', kanji: '眺めより禁煙の方が大事です', korean: '전망보다 금연이 더 중요해요', register: 'productive', tip: '「眺(なが)めより禁煙(きんえん)の方(ほう)が大事(だいじ)です」— 위층 금연룸은 전망이 달라진다는 직원의 설명에, 그래도 금연을 우선하겠다고 답하는 표현이에요. 제안의 조건(전망 변화)에 직접 대응하는 자연스러운 대답입니다' },
  { id: 'p_new_sagaku_koko_de_haraeru', kana: 'さがくはここではらえますか', kanji: '差額はここで払えますか', korean: '차액은 여기서 낼 수 있나요?', register: 'productive', tip: '「差額(さがく)はここで払(はら)えますか」— 오픈 티켓을 교환하며 역무원이 차액(천 엔)을 안내했을 때, 그 자리에서 바로 지불 가능한지 확인하는 표현이에요. 「払える」는 「払う」의 가능형이에요' },
  { id: 'p_new_30pun_go_daijoubu', kana: 'さんじゅっぷんごのれっしゃでだいじょうぶです', kanji: '30分後の列車で大丈夫です', korean: '30분 후 열차로 괜찮아요', register: 'productive', tip: '「30分後(ぷんご)の列車(れっしゃ)で大丈夫(だいじょうぶ)です」— 역무원이 다음 열차가 만석이라며 30분 후 열차를 제안했을 때, 그 제안을 그대로 수락하는 대답이에요' },
  { id: 'p_new_tsuurogawa_de', kana: 'つうろがわでおねがいします', kanji: '通路側でお願いします', korean: '통로 쪽으로 부탁해요', register: 'productive', tip: '「通路側(つうろがわ)でお願(ねが)いします」— 좌석을 통로 측으로 해달라고 답할 때. 반대로 창가는 窓側(まどがわ)라고 해요' },
  { id: 'p_new_madogawa_de', kana: 'まどがわでおねがいします', kanji: '窓側でお願いします', korean: '창가 쪽으로 부탁해요', register: 'productive', tip: '「窓側(まどがわ)でお願(ねが)いします」— 창밖 풍경을 보고 싶을 때. 通路側でお願いします의 반대예요' },
  { id: 'p_new_card_kakunin', kana: 'つかったカードとおなじですか', kanji: '使ったカードと同じですか', korean: '사용했던 카드랑 같은 건가요?', register: 'productive', tip: '「使(つか)ったカードと同(おな)じですか」— 환불을 카드로 돌려준다고 안내받았을 때, 결제에 썼던 그 카드가 맞는지 확인하는 질문이에요' },
  { id: 'p_new_card_ni_henkin', kana: 'もとのカードにへんきんしてください', kanji: '元のカードに返金してください', korean: '원래 카드로 환불해 주세요', register: 'productive', tip: '「元(もと)のカードに返金(へんきん)してください」— 결제했던 카드로 그대로 환불받고 싶을 때 쓰는 표현이에요. 「元の」는 \'원래의\'라는 뜻이에요' },
  { id: 'p_new_genkin_de_henkin', kana: 'げんきんでへんきんしてください', kanji: '現金で返金してください', korean: '현금으로 환불해 주세요', register: 'productive', tip: '「現金(げんきん)で返金(へんきん)してください」— 카드가 아니라 현금으로 돌려받고 싶을 때. 元のカードに返金してください의 반대예요' },
  { id: 'p_new_kono_muki_de_ii', kana: 'このむきであってますか', kanji: 'この向きで合ってますか', korean: '이 방향 맞아요?', register: 'productive', tip: '「この向(む)きで合(あ)ってますか」— 카드를 넣는 방향을 화살표로 안내받았을 때, 자신이 들고 있는 카드 방향이 맞는지 재확인하는 표현이에요. ATM 조작 중 실제로 자주 하는 질문입니다' },
  { id: 'p_new_meisai_shobun', kana: 'しょぶんしておいてください', kanji: '処分しておいてください', korean: '처분해 주세요', register: 'productive', tip: '「処分(しょぶん)しておいてください」— ATM에서 명세표가 필요한지 물었을 때, 받지 않고 그 자리에서 폐기해달라고 정중히 부탁하는 표현이에요. 개인정보가 담긴 명세표를 안전하게 처리해달라는 뉘앙스예요' },
  ...
  { id: 'p_new_seki_ni_modorimasu', kana: 'しつれいしましたせきにもどります', kanji: '失礼しました。席に戻ります', displayKana: 'しつれいしました。せきにもどります', korean: '실례했습니다. 자리로 돌아갈게요', register: 'productive', tip: '「失礼(しつれい)しました。席(せき)に戻(もど)ります」— 지정석 구역이 아니라는 안내를 받고 정중히 사과하며 원래 자리로 돌아가겠다고 말할 때 써요' },
  { id: 'p_new_chizu_misete', kana: 'ちずでみせてもらえますか', kanji: '地図で見せてもらえますか', korean: '지도로 보여주실 수 있어요?', register: 'productive', tip: '「地図(ちず)で見(み)せてもらえますか」— 말로 하는 위치 설명이 복잡할 때, 말 대신 지도로 보여달라고 요청하는 실용적인 표현이에요' },
  { id: 'p_new_betsu_tsuuro_kakunin', kana: 'どのつうろですか', kanji: 'どの通路ですか', korean: '어느 통로인가요?', register: 'productive', tip: '「どの通路(つうろ)ですか」— 공사 중이라 다른 통로를 이용하라는 안내를 받았을 때, 구체적으로 어느 쪽 통로인지 되묻는 자연스러운 질문이에요' },
  { id: 'p_new_koko_de_machimasu', kana: 'ここでまっています', kanji: 'ここで待っています', korean: '여기서 기다릴게요', register: 'productive', tip: '「ここで待(ま)っています」— 조제가 끝날 때까지 그 자리에서 기다리겠다고 답할 때 쓰는 표현이에요' },
];
