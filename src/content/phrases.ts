...
export const phrases: Phrase[] = [
  ...
  // C26 경찰서 / C27 긴급 / C28 통신매장 실전 확장
  { id: 'p_nani_nakushita', kana: 'なにをなくしましたか', kanji: '何をなくしましたか', displayKana: 'なにを、なくしましたか？', korean: '무엇을 잃어버리셨어요?', register: 'receptive' },
  { id: 'p_saifu_nakushita', kana: 'さいふをなくしました', kanji: '財布をなくしました', displayKana: 'さいふを、なくしました', korean: '지갑을 잃어버렸어요', register: 'productive', tip: '「財布(さいふ)をなくしました」— 분실물 신고. 「〇〇をなくしました」패턴으로 パスポート(여권)·スマホ(스마트폰) 등 무엇이든 바꿔 말해요' },
  { id: 'p_funshitsu_todoke', kana: 'ふんしつとどけをかきますか', kanji: '紛失届を書きますか', displayKana: 'ふんしつとどけを、かきますか？', korean: '분실 신고서를 작성하시겠어요?', register: 'receptive' },
  { id: 'p_ugokemasu_ka', kana: 'うごけますか', kanji: '動けますか', displayKana: 'うごけますか？', korean: '움직일 수 있으세요?', register: 'receptive' },
  { id: 'p_ugokemasen', kana: 'うごけません', kanji: '動けません', displayKana: 'うごけません', korean: '움직일 수 없어요', register: 'productive', tip: '「動(うご)けません」— 긴급 상황에서 거동이 어려울 때. 움직이지 말고 도움을 기다리는 게 안전한 경우가 많아요' },
  { id: 'p_jibyou', kana: 'じびょうやおくすりはありますか', kanji: '持病やお薬はありますか', displayKana: 'じびょうや おくすりは、ありますか？', korean: '지병이나 복용 약이 있으세요?', register: 'receptive' },
  ...
  // C31~C40 tier-4 트러블편 확장 프롬프트
  { id: 'p_iro_chigai_arimasu', kana: 'いろちがいもございます', kanji: '色違いもございます', displayKana: 'いろちがいも、ございます', korean: '다른 색상도 있어요', register: 'receptive' },
  ...
  { id: 'p_size_dou', kana: 'りょうはどうしますか', kanji: '量はどうしますか', displayKana: 'りょうは、どうしますか？', korean: '양은 어떻게 하시겠어요?', register: 'receptive' },
  { id: 'p_fukuro_iru', kana: 'ふくろはごりようですか', kanji: '袋はご利用ですか', displayKana: 'ふくろは、ごりようですか？', korean: '봉투 이용하세요?', register: 'receptive' },
  // C41~C50 tier-5 심화편 확장 프롬프트
  { id: 'p_reshiito_omochi', kana: 'レシートはおもちですか', kanji: 'レシートはお持ちですか', displayKana: 'レシートは、おもちですか？', korean: '영수증 가지고 계세요?', register: 'receptive' },
  { id: 'p_henkin_card', kana: 'ごへんきんはカードへおもどしします', kanji: 'ご返金はカードへお戻しします', displayKana: 'ごへんきんは、カードへおもどしします', korean: '환불은 카드로 돌려드릴게요', register: 'receptive' },
  { id: 'p_urikire', kana: 'それはうりきれですね', kanji: 'それは売り切れですね', displayKana: 'それは、うりきれですね', korean: '그건 품절이네요', register: 'receptive' },
  { id: 'p_kingaku_nyuuryoku', kana: 'きんがくをにゅうりょくしてください', kanji: '金額を入力してください', displayKana: 'きんがくを、にゅうりょくしてください', korean: '금액을 입력해 주세요', register: 'receptive' },
  { id: 'p_meisai', kana: 'めいさいひょうはひつようですか', kanji: '明細票は必要ですか', displayKana: 'めいさいひょうは、ひつようですか？', korean: '명세표 필요하세요?', register: 'receptive' },
  { id: 'p_nanbu', kana: 'なんぶいんさつしますか', kanji: '何部印刷しますか', displayKana: 'なんぶ、いんさつしますか？', korean: '몇 부 인쇄하세요?', register: 'receptive' },
  { id: 'p_ryoumen', kana: 'りょうめんいんさつになさいますか', kanji: '両面印刷になさいますか', displayKana: 'りょうめんいんさつに、なさいますか？', korean: '양면 인쇄로 하시겠어요?', register: 'receptive' },
  { id: 'p_chuumon_bangou', kana: 'ちゅうもんばんごうをおねがいします', kanji: '注文番号をお願いします', displayKana: 'ちゅうもんばんごうを、おねがいします', korean: '주문번호를 부탁드려요', register: 'receptive' },
  { id: 'p_sainyuujou', kana: 'さいにゅうじょうスタンプをおします', kanji: '再入場スタンプを押します', displayKana: 'さいにゅうじょうスタンプを、おします', korean: '재입장 스탬프를 찍어 드릴게요', register: 'receptive' },
  { id: 'p_megaphone', kana: 'おうえんメガホンはいかがですか', kanji: '応援メガホンはいかがですか', displayKana: 'おうえんメガホンは、いかがですか？', korean: '응원 메가폰 어떠세요?', register: 'receptive' },
  { id: 'p_elevator', kana: 'エレベーターはあちらです', displayKana: 'エレベーターは、あちらです', korean: '엘리베이터는 저쪽이에요', register: 'receptive' },
  { id: 'p_menzei_counter8', kana: 'めんぜいカウンターははっかいです', kanji: '免税カウンターは8階です', displayKana: 'めんぜいカウンターは、はっかいです', korean: '면세 카운터는 8층이에요', register: 'receptive' },
  { id: 'p_hokenshou_omochi', kana: 'ほけんしょうはおもちですか', kanji: '保険証はお持ちですか', displayKana: 'ほけんしょうは、おもちですか？', korean: '보험증 가지고 계세요?', register: 'receptive' },
  { id: 'p_generic', kana: 'ジェネリックでよろしいですか', displayKana: 'ジェネリックで、よろしいですか？', korean: '제네릭(복제약)으로 괜찮으세요?', register: 'receptive' },
  { id: 'p_omakase_course', kana: 'おまかせコースでよろしいですか', displayKana: 'おまかせコースで、よろしいですか？', korean: '오마카세 코스로 괜찮으세요?', register: 'receptive' },
  { id: 'p_aruku_densha', kana: 'あるくかでんしゃかどちらがいいですか', kanji: '歩くか電車か、どちらがいいですか', displayKana: 'あるくか でんしゃか、どちらがいいですか？', korean: '걷는 것과 전철 중 어느 게 좋으세요?', register: 'receptive' },
  { id: 'p_meijirushi', kana: 'コンビニをめじるしにしてください', kanji: 'コンビニを目印にしてください', displayKana: 'コンビニを、めじるしにしてください', korean: '편의점을 표지로 삼으세요', register: 'receptive' },
  ...
  // ── 마무리·확인 표현 — 단답 「감사합니다」 대신 장면에 맞는 실질적인 응답 ──
  { id: 'p_tasukarimashita', kana: 'たすかりました', kanji: '助かりました', korean: '덕분에 도움이 됐어요', register: 'productive', tip: '「助(たす)かりました」— 길 안내·도움을 받은 뒤 "덕분에 살았어요"라는 뉘앙스. ありがとうございます만 하는 것보다 마음이 더 잘 전달돼요' },
  { id: 'p_yoroshiku_onegai', kana: 'よろしくおねがいします', kanji: 'よろしくお願いします', displayKana: 'よろしく、おねがいします', korean: '잘 부탁드립니다', register: 'productive', tip: '「よろしくお願(ねが)いします」— 체크인·첫 응대에서 "잘 부탁합니다". 키를 받거나 안내를 시작할 때 자연스럽게 곁들이는 만능 표현이에요' },
  { id: 'p_shokugo_kakunin', kana: 'しょくごにのめばいいですか', kanji: '食後に飲めばいいですか', displayKana: 'しょくごに、のめばいいですか？', korean: '식후에 먹으면 되나요?', register: 'productive', grammarRefs: ['g_masuka'], tip: '「食後(しょくご)に飲(の)めばいいですか」— 복용법을 들었으면 핵심을 되물어 확인. 그냥 감사 인사보다 약을 안전하게 먹는 데 훨씬 중요해요. 食前(しょくぜん)=식전, 食後=식후' },
  { id: 'p_kado_de_ii_desu_ka', kana: 'カードでもいいですか', kanji: 'カードでもいいですか', displayKana: 'カードでも、いいですか？', korean: '카드로도 되나요?', register: 'productive', grammarRefs: ['g_masuka'], tip: '「カードでもいいですか」— 결제 전에 카드가 되는지 확인. 일본은 현금만 받는 곳도 많아 미리 물어보면 당황하지 않아요' },
  { id: 'p_otsuri_daijoubu', kana: 'おつりはだいじょうぶです', kanji: 'お釣りは大丈夫です', displayKana: 'おつりは、だいじょうぶです', korean: '거스름돈은 괜찮아요', register: 'productive', tip: '「お釣(つ)りは大丈夫(だいじょうぶ)です」— 잔돈을 안 받겠다는 정중한 표현. 택시·소액 거스름돈을 사양할 때 자연스러워요' },
  { id: 'p_yubi_okimasu', kana: 'はいゆびをおきます', kanji: 'はい、指を置きます', displayKana: 'はい、ゆびをおきます', korean: '네, 손가락 올릴게요', register: 'productive', tip: '「指(ゆび)を置(お)きます」— 입국심사 지문 인식 안내를 따를 때. 안내를 알아듣고 행동으로 답하는 게 그냥 감사 인사보다 훨씬 자연스러워요' },
  { id: 'p_kingaku_kakunin', kana: 'きんがくをかくにんしました', kanji: '金額を確認しました', displayKana: 'きんがくを、かくにんしました', korean: '금액 확인했어요', register: 'productive', tip: '「金額(きんがく)を確認(かくにん)しました」— 환전·계산 후 받은 금액을 확인했다는 표현. 돈 거래에서는 감사보다 확인이 먼저예요' },
  { id: 'p_tsukaikata_wakatta', kana: 'つかいかたがわかりました', kanji: '使い方が分かりました', displayKana: 'つかいかたが、わかりました', korean: '사용법 알겠어요', register: 'productive', tip: '「使(つか)い方(かた)が分(わ)かりました」— 설명을 듣고 이해했다는 신호. 정말 이해했을 때만 쓰고, 헷갈리면 もう一度를 청하는 게 좋아요' },
  { id: 'p_bangou_memo', kana: 'ばんごうをメモしておきます', kanji: '番号をメモしておきます', displayKana: 'ばんごうを、メモしておきます', korean: '번호 메모해 둘게요', register: 'productive', tip: '「番号(ばんごう)をメモしておきます」— 로커 번호·비밀번호를 잊지 않게 적어둘 때. 〜ておきます는 "미리 ~해 두다"라는 준비 표현이에요' },
  { id: 'p_mata_kimasu', kana: 'またきます', kanji: 'また来ます', korean: '또 올게요', register: 'productive', tip: '「また来(き)ます」— 가게를 나서며 "또 올게요". 맛있게 먹은 라멘집·단골 가게에 남기는 기분 좋은 마무리예요. ごちそうさま와 함께 쓰면 자연스러워요' },
  { id: 'p_counter_de_ii', kana: 'カウンターせきでだいじょうぶです', kanji: 'カウンター席で大丈夫です', displayKana: 'カウンターせきで、だいじょうぶです', korean: '카운터석으로 괜찮아요', register: 'productive', tip: '「カウンター席(せき)で大丈夫(だいじょうぶ)です」— 라멘집·혼밥 자리 안내에 답할 때. 주방 앞 카운터석은 혼자 먹기 좋고 회전도 빨라요' },
];
