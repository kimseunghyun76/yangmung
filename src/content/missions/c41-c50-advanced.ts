  ...
  steps: [
    {
      ...
      choices: [
        ...
        { text: '환전해 주세요', phraseId: 'p_ryougae', correct: false, feedback: '환전(両替)은 화폐 교환 — 상품 교환과는 전혀 다른 맥락입니다' },
  ...
  steps: [
    ...
    },
    {
      ...
      choices: [
        ...
        { text: '환전해 주세요', phraseId: 'p_ryougae', correct: false, feedback: '잔돈 확인 상황에서 환전 요청은 맥락과 맞지 않아요' },
      ],
    },
  ],
};
  ...
  steps: [
    ...
    },
    {
      ...
      choices: [
        ...
        { text: '환전해 주세요', phraseId: 'p_ryougae', correct: false, feedback: 'ATM 현금 인출과 환전은 다른 서비스입니다' },
      ],
    },
  ],
};
  ...
  steps: [
    ...
    },
    {
      ...
      choices: [
        ...
        { text: '다시 말해 주세요', phraseId: 'p_mou_ichido', correct: true, recoveryType: 'repeat', recoveryOutcome: 'full' },
        { text: '환전해 주세요', phraseId: 'p_ryougae', correct: false, feedback: '완전히 무관한 요청입니다' },
      ],
    },
    {
  ...
  steps: [
    ...
    },
    {
      ...
      choices: [
        ...
        { text: '접시 가져가도 되나요?', phraseId: 'p_osara_tottemo_ii', correct: false, feedback: '오마카세에서는 접시 회수는 셰프가 합니다' },
      ],
    },
  ],
};
