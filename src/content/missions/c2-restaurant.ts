...
export const c2: Mission = {
  ...
  steps: [
    ...
    },
    {
      ...
      speaker: '나',
      choices: [
        { text: '덮밥 하나 주세요', phraseId: 'p_hitotsu_kudasai', correct: true, feedback: '「一(ひと)つください」— 메뉴 이름 뒤에 붙이면 개수 주문 완성. ひとつ(1)·ふたつ(2)·みっつ(3)·よっつ(4) 패턴으로 10개까지 가능해요' },
        { text: '두 개 주세요', phraseId: 'p_futatsu_kudasai', correct: true, feedback: '「二(ふた)つください」— 여러 개 주문할 때. 손가락으로 숫자를 함께 보여주면 더 확실하게 전달돼요' },
        { text: '이거랑 이거요 (메뉴를 가리키며)', phraseId: 'p_kore_to_kore', correct: true, feedback: '「これとこれ」— 사진 메뉴를 두 손가락으로 가리키면 말이 안 통해도 OK. 가장 안전한 주문법이에요' },
